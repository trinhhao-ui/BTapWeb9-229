...
public class UserController {
    ...
    public String delete(@PathVariable Long id, org.springframework.security.core.Authentication authentication, RedirectAttributes redirect) {
        UserDTO target = userService.findById(id);
        if (target != null && authentication != null && target.getUsername().equals(authentication.getName())) {
            redirect.addFlashAttribute("error", "Không thể tự xóa tài khoản của chính bạn!");
            return "redirect:/users";
        }
